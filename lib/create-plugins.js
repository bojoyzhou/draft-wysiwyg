...
var _draftJsCleanupEmptyPlugin = require('draft-js-plugins/draft-js-cleanup-empty-plugin');

var _draftJsCleanupEmptyPlugin2 = _interopRequireDefault(_draftJsCleanupEmptyPlugin);

var _draftJsEntityPropsPlugin = require('draft-js-plugins/draft-js-entity-props-plugin');

var _draftJsEntityPropsPlugin2 = _interopRequireDefault(_draftJsEntityPropsPlugin);

var _draftJsFocusPlugin = require('draft-js-plugins/draft-js-focus-plugin');

var _draftJsFocusPlugin2 = _interopRequireDefault(_draftJsFocusPlugin);

var _draftJsDndPlugin = require('draft-js-plugins/draft-js-dnd-plugin');

var _draftJsDndPlugin2 = _interopRequireDefault(_draftJsDndPlugin);

var _draftJsToolbarPlugin = require('draft-js-plugins/draft-js-toolbar-plugin');

var _draftJsToolbarPlugin2 = _interopRequireDefault(_draftJsToolbarPlugin);

var _draftJsAlignmentPlugin = require('draft-js-plugins/draft-js-alignment-plugin');

var _draftJsAlignmentPlugin2 = _interopRequireDefault(_draftJsAlignmentPlugin);

var _draftJsResizeablePlugin = require('draft-js-plugins/draft-js-resizeable-plugin');

var _draftJsResizeablePlugin2 = _interopRequireDefault(_draftJsResizeablePlugin);

var _draftJsImagePlugin = require('draft-js-plugins/draft-js-image-plugin');

var _draftJsImagePlugin2 = _interopRequireDefault(_draftJsImagePlugin);

var _draftJsTablePlugin = require('draft-js-plugins/draft-js-table-plugin');

var _draftJsTablePlugin2 = _interopRequireDefault(_draftJsTablePlugin);

require('draft-js-plugins/draft-js-alignment-plugin/lib/plugin.css');

require('draft-js-plugins/draft-js-focus-plugin/lib/plugin.css');

require('draft-js-plugins/draft-js-image-plugin/lib/plugin.css');

require('draft-js-plugins/draft-js-table-plugin/lib/plugin.css');

require('draft-js-plugins/draft-js-toolbar-plugin/lib/plugin.css');

var _addBlock = require('draft-js-plugins/draft-js-dnd-plugin/lib/modifiers/addBlock');
...
exports.default = function (_ref) {
  ...
  var plugins = _ref$plugins === undefined ? function () {} : _ref$plugins;
  var _ref$toolbar = _ref.toolbar;
  var toolbar = _ref$toolbar === undefined ? { disableItems: [], textActions: [] } : _ref$toolbar;
