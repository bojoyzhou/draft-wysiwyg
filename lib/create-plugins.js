...
var _bjDraftJsDndPlugin = require('bj-draft-js-dnd-plugin');

var _bjDraftJsDndPlugin2 = _interopRequireDefault(_bjDraftJsDndPlugin);
...
var _addBlock = require('bj-draft-js-dnd-plugin/lib/modifiers/addBlock');
...
var image = (0, _draftJsResizeablePlugin.ResizeableDecorator)({
  ...
  handles: true,
  vertical: 'auto'
})((0, _bjDraftJsDndPlugin.DraggableDecorator)((0, _draftJsFocusPlugin.FocusDecorator)((0, _draftJsAlignmentPlugin.AlignmentDecorator)((0, _draftJsToolbarPlugin.ToolbarDecorator)()((0, _draftJsImagePlugin.imageCreator)({ theme: _draftJsImagePlugin.imageStyles }))))));
var table = (0, _draftJsFocusPlugin.FocusDecorator)((0, _bjDraftJsDndPlugin.DraggableDecorator)((0, _draftJsToolbarPlugin.ToolbarDecorator)()((0, _draftJsTablePlugin.tableCreator)({ theme: _draftJsTablePlugin.tableStyles, Editor: _draftJsPluginsEditorWysiwyg2.default }))));
...
exports.default = function (_ref) {
  ...
  }), (0, _draftJsFocusPlugin2.default)({}), (0, _draftJsAlignmentPlugin2.default)({}), (0, _bjDraftJsDndPlugin2.default)({
    allowDrop: true,
